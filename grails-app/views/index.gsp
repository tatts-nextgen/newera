...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="row" style="color: #afafaf;">
                    <div class="col-xs-1 col-xs-offset-3 vcenter">
                        <span class="fa-stack" data-hidden-field="over18">
                            <i class="fa fa-square-o checkable fa-stack-2x"></i>
            ...
            <div class="row">
                <button class="btn col-xs-7 col-xs-offset-3" disabled="disabled"
                    style="background-color: #afafaf; color: #000; margin-bottom: 25px;">SUBMIT</button>
            </div>
        </div>
    </div>
</div>
